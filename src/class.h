...
extern const char *class_colors[];
extern const char *show_color[];
extern const char *pc_class_types[];
extern const char *pc_special_abs[];
extern const char *cosmetic_color[];
extern const char *eye_color[];
extern const char *hair_style[];
extern const char *class_menu;
extern const char *skin_menu;
extern const char *eye_menu;
extern const char *hair_menu;
extern const char *hcolor_menu;
