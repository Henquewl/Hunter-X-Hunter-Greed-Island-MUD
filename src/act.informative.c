...
/* Per-card image URLs from static.wikia.nocookie.net (HxH fandom wiki).
   NULL means no image available for that card. */
static const char *restricted_card_image_urls[100] = {
  ...
  /* 002 Plot of Beach       */ "https://static.wikia.nocookie.net/hunterxhunter/images/b/be/Patch_of_Shore_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 031 Double Postcard     */ "https://static.wikia.nocookie.net/hunterxhunter/images/8/89/Double_Postcard_to_the_Dead_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 053 King White Stag Btl */ "https://static.wikia.nocookie.net/hunterxhunter/images/7/7e/King_Great_White_Beetle_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 059 Inst. Foreign Lang  */ "https://static.wikia.nocookie.net/hunterxhunter/images/6/63/Instant_Foreign_Language_School_%28G.I_card%29_%3Dscan%3D.png",
  /* 060 Long Lost Delivery  */ "https://static.wikia.nocookie.net/hunterxhunter/images/9/9e/Long_Lost_Delivery_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 062 Club You Rule       */ "https://static.wikia.nocookie.net/hunterxhunter/images/6/6c/Club_%22You_Rule%22_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 067 Doyen's Growth Pills*/ "https://static.wikia.nocookie.net/hunterxhunter/images/2/2c/Doyen%27s_Growth_Pills_%28G.I_card%29_%3Dscan%3D.png",
  /* 068 Doyen's Virility Pil*/ "https://static.wikia.nocookie.net/hunterxhunter/images/0/00/Doyen%27s_Virility_Pills_%28G.I_card%29_%3Dscan%3D.png",
  /* 069 Doyen's Hair Restor */ "https://static.wikia.nocookie.net/hunterxhunter/images/7/76/Doyen%27s_Hair_Restorer_%28G.I_card%29_69.png",
  /* 070 Mad Sci Steroids    */ "https://static.wikia.nocookie.net/hunterxhunter/images/0/00/Mad_Scientist%27s_Steroids_%28G.I_card%29_70.png",
...
/* Spell card image URLs. Index = vnum - 1000 (covers 1000-1040). */
static const char *spell_card_image_urls[41] = {
  /* 1000 Eliminate (-003)   */ "https://static.wikia.nocookie.net/hunterxhunter/images/b/b0/Elliminate_%28G.I_card%29.png",
  /* 1001 Peek               */ "https://static.wikia.nocookie.net/hunterxhunter/images/2/24/Steal_%28G.I_card%29_%3Dscan%3D.png",
  /* 1002 Fluoroscopy        */ "https://static.wikia.nocookie.net/hunterxhunter/images/b/be/Fluroscopy_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 1010 Mimic              */ "https://static.wikia.nocookie.net/hunterxhunter/images/c/c2/Transform_%28G.I_card%29_%3Dscan%3D.png",
  /* 1011 Clone              */ "https://static.wikia.nocookie.net/hunterxhunter/images/1/1f/Clone_%28G.I_card%29.png",
  /* 1012 Relegate           */ "https://static.wikia.nocookie.net/hunterxhunter/images/c/cd/Railguide_%28G.I_card%29_%3Dscan%3D.png",
  /* 1013 Origin             */ "https://static.wikia.nocookie.net/hunterxhunter/images/7/71/Departure_%28G.I_card%29_%3Dscan%3D.png",
  /* 1014 Leave              */ "https://static.wikia.nocookie.net/hunterxhunter/images/7/7e/Leave_%28G.I_card%29.png",
  /* 1015 Clairvoyance       */ "https://static.wikia.nocookie.net/hunterxhunter/images/0/03/Sightvision_Rule_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 1019 Drawbridge         */ "https://static.wikia.nocookie.net/hunterxhunter/images/5/57/Castle_Gate_%28G.I_card%29_%3Dscan%3D.png",
  /* 1020 Fake               */ "https://static.wikia.nocookie.net/hunterxhunter/images/3/3c/Fake_%28G.I_card%29.png",
  /* 1021 Mug                */ "https://static.wikia.nocookie.net/hunterxhunter/images/f/fc/Rob_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 1024 Dispel             */ "https://static.wikia.nocookie.net/hunterxhunter/images/c/ce/Penetrate_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 1028 Rock Toss          */ "https://static.wikia.nocookie.net/hunterxhunter/images/9/92/Stone_Throw_%28G.I_card%29_%3Dscan%3D.png",
  /* 1029 Bullet             */ "https://static.wikia.nocookie.net/hunterxhunter/images/f/f9/Shot_%28G.I_card%29_%3Dscan%3D.png",
  ...
  /* 1033 Cling              */ "https://static.wikia.nocookie.net/hunterxhunter/images/d/dc/Adhesion_Rule_%28G.I_card%29_%3Dscan%3D.png",
  /* 1034 Purify             */ "https://static.wikia.nocookie.net/hunterxhunter/images/5/5c/Purify_%28G.I_card%29_%3Dscan%3D.png",
  /* 1035 Fortress           */ "https://static.wikia.nocookie.net/hunterxhunter/images/c/cd/Prison_%28G.I_card%29_%3Dscan%3D.png",
  /* 1036 Eye of God         */ "https://static.wikia.nocookie.net/hunterxhunter/images/e/e4/God_Eye_%28G.I_card%29_%3Dscan%3D.png",
...
static void send_card_image(struct char_data *ch, struct obj_data *obj)
{
  ...
  ch->desc->prompt_delay_until = (long)pulse + 7L; /* 700ms (7 pulses of 100ms) */
}
...
static void look_at_char(struct char_data *i, struct char_data *ch)
{
  ...
  if (found) {	
    ...
    for (j = 0; j < NUM_WEARS; j++)
      if (GET_EQ(i, j) && CAN_SEE_OBJ(ch, GET_EQ(i, j))) {
	send_to_char(ch, "%s[ %s%s%s]%s  ", QBCYN, QCYN, wear_where[j], QBCYN, QNRM);
...
static void list_one_char(struct char_data *i, struct char_data *ch)
{
  ...
  if (IS_NPC(i) && i->player.long_descr && GET_POS(i) == GET_DEFAULT_POS(i)) {
    ...
    if (AFF_FLAGGED(i, AFF_FLYING) && GET_LEVEL(i) < LVL_IMMORT)
      act("...$e is hovering over the ground!", FALSE, i, 0, ch, TO_VICT);    
  ...
  if (AFF_FLAGGED(i, AFF_FLYING))
    act("...$e is hovering over the ground!", FALSE, i, 0, ch, TO_VICT);  
  if (PLR_FLAGGED(i, PLR_BOOK))
	act("...$e is with the \tcG.I. \tBBook\ty open!\tn", FALSE, i, 0, ch, TO_VICT);
...
void look_at_room(struct char_data *ch, int ignore_brief)
{
  ...
  if (IS_DARK(IN_ROOM(ch)) && !CAN_SEE_IN_DARK(ch)) {
    send_to_char(ch, "It is pitch black... cannot see anything!\r\n");
    return;
...
static void look_at_target(struct char_data *ch, char *arg)
{
  ...
  if (found_char != NULL) {
	...
	if (found_char == ch) {
      act("$n looks self.", TRUE, ch, 0, found_char, TO_ROOM);
	}
    return;
  }
...
ACMD(do_gold)
{
  if (GET_GOLD(ch) == 0)
    ...
    send_to_char(ch, "You have %d Jenny.\r\n", GET_GOLD(ch));
}
...
ACMD(do_score)
{
  ...
  calc_accuracy += str_app[STRENGTH_APPLY_INDEX(ch)].tohit;
  calc_accuracy += GET_HITROLL(ch);
...
/*  send_to_char(ch, "You have earned %d quest points.\r\n", GET_QUESTPOINTS(ch));
  ...
  */
  ...
  send_to_char(ch, "You have been playing for %d day%s and %d hour%s.%s\r\n",
     ...
     playing_time.hours, playing_time.hours == 1 ? "" : "s", QNRM);
  ...
  if (AFF_FLAGGED(ch, AFF_SNEAK))
    send_to_char(ch, "You are moving silently.\r\n");

  if (AFF_FLAGGED(ch, AFF_FLYING))
    send_to_char(ch, "You are hovering over the ground.\r\n");

  if (AFF_FLAGGED(ch, AFF_INVISIBLE))
    send_to_char(ch, "You are invisible.\r\n");

  if (AFF_FLAGGED(ch, AFF_DETECT_INVIS))
    send_to_char(ch, "You are sensitive to invisible things.\r\n");
  ...
  if (AFF_FLAGGED(ch, AFF_CURSE))
    send_to_char(ch, "You are cursed!\r\n");

  if (AFF_FLAGGED(ch, AFF_CHARM))
    send_to_char(ch, "You have been charmed!\r\n");

  if (affected_by_spell(ch, SPELL_ARMOR))
    send_to_char(ch, "You feels protected.\r\n");

  if (affected_by_spell(ch, SPELL_BLESS))
    send_to_char(ch, "You feels focused.\r\n");
...
*/
  ...
  for (i = 0; *rank[i].disp != '\n'; i++) {
    ...
    if (short_list)
      send_to_char(ch, "Online Players\r\n-------\r\n");
    else
...
*/
  ...
  send_to_char(ch, "%sAura Type: %s%s\r\n", CCYEL(ch, C_NRM), CCCYN(ch, C_NRM), buf);
  
  if (AFF_FLAGGED(ch, AFF_DETECT_ALIGN) || GET_LEVEL(ch) >= LVL_GOD) {
    if (GET_ALIGNMENT(victim) >= 350) {
      send_to_char(ch, "%sAlign: %sGood\r\n", CCYEL(ch, C_NRM), CBBLU(ch, C_NRM));
    }
  
    if (GET_ALIGNMENT(victim) <= -350) {
      send_to_char(ch, "%sAlign: %sEvil\r\n", CCYEL(ch, C_NRM), CBRED(ch, C_NRM));
    }
  
    if (GET_ALIGNMENT(victim) < 350 && GET_ALIGNMENT(victim) > -350) {
      send_to_char(ch, "%sAlign: %sNeutral\r\n", CCYEL(ch, C_NRM), CBWHT(ch, C_NRM));
    }
  }
  ...
  if (GET_COND(victim, HUNGER) == 0) {
    send_to_char(ch, "%s are hungry.\r\n", HSSH(victim));
	}

  if (GET_COND(victim, THIRST) == 0) {
    send_to_char(ch, "%s are thirsty.\r\n", HSSH(victim));
	}

  if (AFF_FLAGGED(victim, AFF_BLIND)) {
    send_to_char(ch, "%s have been blinded!\r\n", HSSH(victim));
	}

  if (AFF_FLAGGED(victim, AFF_SNEAK)) {
    send_to_char(ch, "%s are moving silently.\r\n", HSSH(victim));
	}

  if (AFF_FLAGGED(victim, AFF_FLYING)) {
    send_to_char(ch, "%s are hovering over the ground.\r\n", HSSH(victim));
	}

  if (AFF_FLAGGED(victim, AFF_INVISIBLE)) {
    send_to_char(ch, "%s are invisible.\r\n", HSSH(victim));
	}

  if (AFF_FLAGGED(victim, AFF_DETECT_INVIS)) {
    send_to_char(ch, "%s are sensitive to invisible things.\r\n", HSSH(victim));
	}

  if (AFF_FLAGGED(victim, AFF_DETECT_ALIGN)) {
    send_to_char(ch, "%s are sensitive to people's intentions.\r\n", HSSH(victim));
	}
  ...
  if (AFF_FLAGGED(victim, AFF_CURSE)) {
    send_to_char(ch, "%s are cursed!\r\n", HSSH(victim));
	}

  if (AFF_FLAGGED(victim, AFF_CHARM)) {
    send_to_char(ch, "%s have been charmed!\r\n", HSSH(victim));
	}
  ...
  if (affected_by_spell(victim, SPELL_BLESS)) {
    send_to_char(ch, "%s feels focused.\r\n", HSSH(victim));
	}

  if (AFF_FLAGGED(victim, AFF_INFRAVISION)) {
    send_to_char(ch, "%s eyes are glowing red.\r\n", HSSH(victim));
	}

  if (PRF_FLAGGED(victim, PRF_SUMMONABLE)) {
    send_to_char(ch, "%s are summonable by other players.\r\n", HSSH(victim));
	}

  if (!(GET_LEVEL(victim) > LVL_IMMORT) || ((GET_LEVEL(ch) / 2) > (GET_LEVEL(victim)))) {
    strftime(buf, sizeof(buf), "%a %b %d %Y", localtime(&(victim->player.time.logon)));

    hours = (time(0) - victim->player.time.logon) / 3600;

    if (!got_from_file) {
      send_to_char(ch, "%sLast Logon: %sPlaying now!  (Idle %d Minutes)", CCYEL(ch, C_NRM), CCCYN(ch, C_NRM),
      ...
      send_to_char(ch, "%sLast Logon: %s%s (%d days & %d hours ago.)\r\n", CCYEL(ch, C_NRM), CCCYN(ch, C_NRM), buf, hours/24, hours%24);
    else
      send_to_char(ch, "%sLast Logon: %s%s (0 hours & %d minutes ago.)\r\n", CCYEL(ch, C_NRM), CCCYN(ch, C_NRM),
