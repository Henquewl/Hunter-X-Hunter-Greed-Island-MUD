          ...
          if (subfield && *subfield) {
            if (!str_cmp(subfield, "vnum"))
              ...
              if (R_EXIT(r, NORTHEAST)->to_room != NOWHERE)
                snprintf(str, slen, "%c%ld", UID_CHAR, (long) world[R_EXIT(r, NORTHEAST)->to_room].number + ROOM_ID_BASE);
              else
                *str = '\0';
            }
          } else /* no subfield - default to bits */
          ...
          if (subfield && *subfield) {
            if (!str_cmp(subfield, "vnum"))
              ...
              if (R_EXIT(r, NORTHWEST)->to_room != NOWHERE)
                snprintf(str, slen, "%c%ld", UID_CHAR, (long) world[R_EXIT(r, NORTHWEST)->to_room].number + ROOM_ID_BASE);
              else
                *str = '\0';
            }
          } else /* no subfield - default to bits */
          ...
          if (subfield && *subfield) {
            if (!str_cmp(subfield, "vnum"))
              ...
              if (R_EXIT(r, SOUTHEAST)->to_room != NOWHERE)
                snprintf(str, slen, "%c%ld", UID_CHAR, (long) world[R_EXIT(r, SOUTHEAST)->to_room].number + ROOM_ID_BASE);
              else
                *str = '\0';
            }
          } else /* no subfield - default to bits */
          ...
          if (subfield && *subfield) {
            if (!str_cmp(subfield, "vnum"))
              ...
              if (R_EXIT(r, SOUTHWEST)->to_room != NOWHERE)
                snprintf(str, slen, "%c%ld", UID_CHAR, (long) world[R_EXIT(r, SOUTHWEST)->to_room].number + ROOM_ID_BASE);
              else
                *str = '\0';
            }
          } else /* no subfield - default to bits */
