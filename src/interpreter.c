...
//  { "cast"     , "c"       , POS_SITTING , do_cast     , 1, 0 },
  ...
  { "senselife",  "sens"   , POS_SITTING , do_cast     , 1, SPELL_SENSE_LIFE },
  ...
  { "smiteevil",  "smitee" , POS_SITTING , do_cast     , 1, SPELL_DISPEL_EVIL },
  { "smitegood",  "smiteg" , POS_SITTING , do_cast     , 1, SPELL_DISPEL_GOOD },
  ...
  { "dowsingchain", "dows"  , POS_SITTING , do_cast     , 1, SPELL_DOWSING_CHAIN },  
  ...
  { "gossip"   , "gos"     , POS_DEAD    , do_gen_comm , 0, SCMD_GOSSIP },
  { "group"    , "gr"      , POS_RESTING , do_group    , 1, 0 },
  { "grab"     , "grab"    , POS_RESTING , do_grab     , 0, 0 },
  { "grats"    , "grat"    , POS_SLEEPING, do_gen_comm , LVL_IMMORT, SCMD_GRATZ },
  ...
  { "holler"   , "holler"  , POS_RESTING , do_gen_comm , 0, SCMD_HOLLER },
  ...
  { "nograts"  , "nograts" , POS_DEAD    , do_gen_tog  , LVL_IMMORT, SCMD_NOGRATZ },
  { "nohassle" , "nohassle", POS_DEAD    , do_gen_tog  , LVL_IMMORT, SCMD_NOHASSLE },
  { "norepeat" , "norepeat", POS_DEAD    , do_gen_tog  , LVL_IMMORT, SCMD_NOREPEAT },
  { "noshout"  , "noshout" , POS_SLEEPING, do_gen_tog  , LVL_IMMORT, SCMD_NOSHOUT },
  { "nosummon" , "nosummon", POS_DEAD    , do_gen_tog  , 1, SCMD_NOSUMMON },
  { "notell"   , "notell"  , POS_DEAD    , do_gen_tog  , LVL_IMMORT, SCMD_NOTELL },
  ...
  { "offer"    , "off"     , POS_STANDING, do_not_here , LVL_IMMORT, 0 },
  { "ooc"      , "oo"      , POS_DEAD    , do_gen_comm , 0, SCMD_GOSSIP },
  ...
  { "practice" , "pr"      , POS_SLEEPING , do_practice , 1, 0 },
...
//  { "scan"     , "sca"     , POS_RESTING , do_scan     , 1, 0 },
  ...
  { "skills"    , "sk"      , POS_SLEEPING, do_practice , 1, 0 },
  ...
  case CON_GET_NAME:		/* wait for input of name */
    ...
    if (!*arg)
      ...
      if ((_parse_name(arg, tmp_name)) || strlen(tmp_name) < 2 ||
       strlen(tmp_name) > 10 || !valid_name(tmp_name) ||
