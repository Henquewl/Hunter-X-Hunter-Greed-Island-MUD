...
eval dam1 (%actor.level% + %consume%) / 4
...
eval consume %actor.maxmana% / 4
nop %actor.mana(-%consume%)%
eval dam2 (%actor.level% + %consume%) / 3
...
nop %actor.mana(-%consume%)%
eval dam3 (%actor.level% + %consume%) / 2
...
nop %actor.mana(-%consume%)%
eval dam4 %actor.level% + %consume%
eval dam123 (%dam1% + %dam2% + %dam3%)
eval dammax (%dam1% + %dam2% + %dam3% + %dam4%)
if %dammax% > 126
nop %actor.damroll(-%actor.damroll%)%
